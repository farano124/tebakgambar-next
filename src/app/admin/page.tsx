...
import LevelUploadForm from '@/components/admin/LevelUploadForm'
import { Shield, Users, Settings, ArrowLeft, UserCheck, UserX, Upload, Gamepad2 } from 'lucide-react'
...
export default function AdminPage() {
  ...
  }, [user, loading, router, checkAdminAccess])
  ...
  return (
    <div className="min-h-screen p-4 slide-in-up">
      ...
      <div className="max-w-6xl mx-auto mb-8 slide-in-up">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass-card-enhanced p-6 text-center floating bounce-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="text-3xl font-bold rainbow-text">100</div>
            <div className="text-white/70 font-medium">Total Level</div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto mb-6 slide-in-up">
        <div className="glass-card-enhanced p-2 floating">
        ...
        {activeTab === 'users' ? (
          ...
          <div className="space-y-6">
            <div className="glass-card-enhanced p-6 floating">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold rainbow-text flex items-center">
                  <Upload className="w-8 h-8 mr-3 pulse-glow" />
                  Tambah Level Baru
                </h2>
                <div className="text-sm text-white/70">
                  Upload gambar dan data level ke database
                </div>
              </div>

              <LevelUploadForm onLevelAdded={() => {
